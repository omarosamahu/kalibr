...
PinholeCameraGeometry::PinholeCameraGeometry(double focalLengthU,
                                             ...
                                             double imageCenterV,
                                             int resolutionU, int resolutionV,
                                             double k1, double k2,double k3, double p1,
                                             double p2)
    : _fu(focalLengthU),
      _fv(focalLengthV),
      _cu(imageCenterU),
...
void PinholeCameraGeometry::distortion(double mx_u, double my_u, double *dx_u,
  ...
  *dxdmx = 1 + rad_dist_u + _k1 * 2 * mx2_u + _k2 * rho2_u * 4 * mx2_u + _k3 * 6 * rho2_u * rho2_u * mx2_u
      + 2 * _p1 * my_u + 6 * _p2 * mx_u; // Omar
  *dydmx = _k1 * 2 * mx_u * my_u + _k2 * 4 * rho2_u * mx_u * my_u + _k3 * 6 * rho2_u * rho2_u * mx_u * my_u
      + _p1 * 2 * mx_u + 2 * _p2 * my_u; // Omar
  *dxdmy = *dydmx;
  *dydmy = 1 + rad_dist_u + _k1 * 2 * my2_u + _k2 * rho2_u * 4 * my2_u + _k3 * 6 * rho2_u * rho2_u * my2_u
      + 6 * _p1 * my_u + 2 * _p2 * mx_u; // Omar
}
